// =============================================================
// Benchmark: Publish Notification
// =============================================================
...
public class PublishNotificationBenchmark
{
    ...
    public void Setup()
    {
        ...
        mediatRServices.AddMediatR(cfg =>
            cfg.RegisterServicesFromAssemblyContaining<MediatRMessages.PingNotification>());
    ...
    public async ValueTask TurboMediator()
    {
        ...
        await mediator.Publish(new TurboHandlers.PingNotification());
    }
    ...
    public async Task MediatR()
    {
        ...
        await mediator.Publish(new MediatRMessages.PingNotification());
    }
    ...
    public async ValueTask Mediator_SourceGen()
    {
        ...
        await mediator.Publish(new SourceGenHandlers.PingNotification());
    }
}
